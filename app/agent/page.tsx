              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  style={{
                    ...
                    boxShadow: '0 8px 32px rgba(178,58,43,0.35)',
                  }}
                >
                ...
                <form onSubmit={requestCall} className="flex-1 flex flex-col gap-4">
                  ...
                  <div className="mt-auto">
                    <button
                      ...
                      style={{ background: 'linear-gradient(135deg, #3B82F6, #2563EB)', boxShadow: '0 8px 32px rgba(178,58,43,0.35)' }}
                    >
        ...
        <div className="w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {capabilities.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="border border-hairline rounded-2xl p-6 hover:border-sky-soft hover:shadow-[0_8px_30px_rgba(178,58,43,0.08)] transition-all duration-300">
          ...
          <div className="text-center mt-14">
            <Link
              ...
              style={{ background: 'linear-gradient(135deg, #2563EB, #3B82F6)', boxShadow: '0 8px 32px rgba(178,58,43,0.35)' }}
            >
