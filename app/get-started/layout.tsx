...
export const metadata: Metadata = {
  ...
  description: 'Tell us what you need — ServiceNow, an AI agent, an app, or a site. You get a written plan within two working days: approach, sequence, team, and an estimate you can budget against.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Tell us what you need. A written plan within two working days — approach, sequence, team, and estimate.',
