  ...
  if (typeof document !== 'undefined') {
    ...
    if (element) {
      element.scrollIntoView({ behavior: 'smooth' });
        ...
        {/* Benefits Section */}
        <section id="benefits" className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-indigo-50/30 relative overflow-hidden">
                ...
                <div key={index} className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-violet-200 transform hover:-translate-y-2">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="bg-gradient-to-r from-violet-50 to-fuchsia-50 rounded-xl p-4 border border-violet-200">
                      <div className="text-sm font-semibold text-violet-700 mb-1">Key Benefit</div>
                      <div className="text-violet-600 text-lg font-bold">{feed.benefit}</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {advancedCapabilities.map((capability, index) => (
                <div key={index} className="group bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-fuchsia-200 transform hover:-translate-y-2">
