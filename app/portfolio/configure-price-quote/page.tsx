            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white space-y-4 sm:space-y-8 px-2 sm:px-0">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-4 mb-6 sm:mb-8">
                  <Badge className="bg-gradient-to-r from-violet-500/90 to-purple-600/90 backdrop-blur-sm text-white border-transparent text-[10px] sm:text-sm py-0.5 sm:py-1 px-1.5 sm:px-3 hover:from-violet-600 hover:to-purple-700 transition-all duration-300">
                    <Award className="w-3 h-3 mr-1" />
                    ServiceNow Certified
                  </Badge>
                  <Badge className="bg-gradient-to-r from-purple-500/90 to-fuchsia-600/90 backdrop-blur-sm text-white border-transparent text-[10px] sm:text-sm py-0.5 sm:py-1 px-1.5 sm:px-3 hover:from-purple-600 hover:to-fuchsia-700 transition-all duration-300">
                    <Sparkles className="w-3 h-3 mr-1" />
                    AI-Powered CPQ
                  </Badge>
                  <Badge className="bg-gradient-to-r from-fuchsia-500/90 to-pink-500/90 backdrop-blur-sm text-white border-transparent text-[10px] sm:text-sm py-0.5 sm:py-1 px-1.5 sm:px-3 hover:from-fuchsia-600 hover:to-pink-600 transition-all duration-300">
                ...
                <p className="text-sm sm:text-base md:text-lg text-violet-100 max-w-[280px] sm:max-w-2xl leading-relaxed">
  ...
  if (typeof document !== 'undefined') {
    ...
    if (element) {
      element.scrollIntoView({ behavior: 'smooth' });
        ...
        <section className="py-4 sm:py-16 md:py-24 bg-gradient-to-r from-rose-900 via-pink-900 to-fuchsia-900 text-white relative overflow-hidden">
        ...
        <section className="py-4 sm:py-16 md:py-24 bg-gradient-to-br from-gray-50 to-rose-50/30 relative overflow-hidden">
          <div className="w-[92%] sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto text-center">
            <div className="bg-gradient-to-r from-rose-600 via-pink-600 to-fuchsia-600 rounded-3xl p-4 sm:p-8 md:p-16 text-white relative overflow-hidden">
              <div className="absolute inset-0 bg-grid-pattern opacity-10" />
              <div className="relative z-10">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                  <button 
                    onClick={() => window.open('https://meetings.hubspot.com/ifbash', '_blank')}
                    className="px-3 sm:px-8 py-2 sm:py-4 bg-white text-rose-600 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
                    Contact CPQ Experts
