  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 width-sm-fix overflow-x-hidden max-w-[100vw]">
        {/* Hero Section */}
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-violet-900 via-purple-900 to-indigo-900 py-4 sm:py-16 md:py-24 w-full">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white space-y-4 sm:space-y-8 px-2 sm:px-0">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-4 mb-6 sm:mb-8">
                  <Badge className="text-[10px] sm:text-sm py-0.5 sm:py-1 px-1.5 sm:px-3 bg-gradient-to-r from-violet-500/90 to-purple-600/90 backdrop-blur-sm text-white border-transparent whitespace-nowrap hover:from-violet-600 hover:to-purple-700 transition-all duration-300">
            ...
            <div className="bg-gradient-to-r from-teal-600 via-green-600 to-emerald-600 p-4 sm:p-8 md:p-16 rounded-xl sm:rounded-3xl text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                  <button 
                    onClick={() => window.open('https://meetings.hubspot.com/ifbash', '_blank')}
                    className="text-xs sm:text-base px-3 sm:px-8 py-2 sm:py-4 bg-white text-teal-600 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
                    Contact DEX Experts
