        ...
        <div className="relative z-10 w-full px-4 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto py-12 sm:py-14">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 leading-[1.06] tracking-tight mb-6">
              Your employees deserve<br /><span className="text-indigo-600">invisible IT.</span>
            </h1>
            <p className="text-lg text-gray-500 leading-relaxed mb-10 max-w-xl">
              Measure and continuously improve the technology experience for every employee. <span className="text-gray-900 font-semibold">90% satisfaction. 80% proactive resolution.</span> IT that works before they notice.
            </p>
