  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-teal-900 via-cyan-900 to-sky-900">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white space-y-8">
                ...
                <div className="flex items-center justify-start gap-2 sm:gap-4 mb-6 sm:mb-8 flex-wrap px-2 sm:px-0">
                  ...
                  <Badge className="bg-gradient-to-r from-cyan-500/90 to-sky-600/90 backdrop-blur-sm text-white border-transparent text-[10px] sm:text-sm whitespace-nowrap py-1 px-2 sm:px-3 hover:from-cyan-600 hover:to-sky-700 transition-all duration-300">
                    <Sparkles className="w-3 h-3 mr-1" />
                    AI-Powered GRC
                  </Badge>
                  <Badge className="bg-gradient-to-r from-sky-500/90 to-blue-500/90 backdrop-blur-sm text-white border-transparent text-[10px] sm:text-sm whitespace-nowrap py-1 px-2 sm:px-3 hover:from-sky-600 hover:to-blue-600 transition-all duration-300">
  ...
  if (typeof document !== 'undefined') {
    ...
    if (element) {
      element.scrollIntoView({ behavior: 'smooth' });
        ...
        <section className="py-16 md:py-24 bg-gradient-to-r from-purple-900 via-violet-900 to-indigo-900 text-white relative overflow-hidden">
