            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white space-y-4 sm:space-y-8 px-2 sm:px-0">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-4 mb-6 sm:mb-8">
                  ...
                  <Badge className="bg-gradient-to-r from-cyan-500/90 to-blue-600/90 backdrop-blur-sm text-white border-transparent text-[10px] sm:text-sm py-0.5 sm:py-1 px-1.5 sm:px-3 hover:from-cyan-600 hover:to-blue-700 transition-all duration-300">
                    <Sparkles className="w-3 h-3 mr-1" />
                    AI-Powered CPQ
                  </Badge>
                  <Badge className="bg-gradient-to-r from-blue-500/90 to-indigo-500/90 backdrop-blur-sm text-white border-transparent text-[10px] sm:text-sm py-0.5 sm:py-1 px-1.5 sm:px-3 hover:from-blue-600 hover:to-indigo-600 transition-all duration-300">
                ...
                <p className="text-sm sm:text-base md:text-lg text-orange-100 max-w-[280px] sm:max-w-2xl">
      ...
      element.scrollIntoView({ behavior: 'smooth' });
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-blue-50/30 relative overflow-hidden">
          <div className="w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-8">
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-purple-50/30 relative overflow-hidden">
          <div className="w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto text-center">
            <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 rounded-3xl p-4 sm:p-8 md:p-16 text-white relative overflow-hidden">
              <div className="absolute inset-0 bg-grid-pattern opacity-10" />
              <div className="relative z-10">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
