...
export default function EnterpriseArchitecturePage() {
  ...
  const caseStudies = [
    {
      title: "IBM Transforms Enterprise Architecture with ServiceNow Visibility",
      client: "IBM",
      ...
      testimonial: "What we can see, we can manage; and with ServiceNow, we can see all the applications everybody has across all of IBM",
      executive: "Alison Sorbet, Operations Manager at IBM",
              ...
              <div className="relative z-10">
                ...
                <div className="grid sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                    ...
                    <p className="text-white text-sm font-medium">ea-experts@ifbash.com</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
