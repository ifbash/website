...
import { ArrowRight, BarChart3, CheckCircle, ChevronDown, ChevronLeft, ChevronRight, ClipboardCheck, Clock, Cloud, Cog, Eye, Lightbulb, MessageCircle, Rocket, Search, Shield, Target, TrendingUp } from 'lucide-react';
...
export default function CloudObservabilityPage() {
        ...
        <div className="relative z-10 w-full px-4 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.06] tracking-tight mb-6">We don't just observe systems.<br /><span style={{ color: '#818cf8' }}>We make them reliable.</span></h2>
              <p className="text-slate-400 text-base lg:text-lg max-w-2xl mx-auto leading-relaxed mb-12">We start with your SLOs and your on-call teams, not the platform.</p>
            </div>
      ...
      <section className="py-16 relative overflow-hidden" style={{ background: '#07071a' }}>
        ...
        <div className="relative z-10 w-full px-4 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto text-center">
          <div className="max-w-xl mx-auto rounded-3xl border p-8 sm:p-10 text-center" style={{ borderColor: `${A}4d`, background: `linear-gradient(135deg, ${A}14, ${A}07)` }}>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white leading-tight mb-3">Ready for unified observability?</h2>
            <p className="text-slate-400 text-sm max-w-sm mx-auto mb-6">Tell us about your monitoring landscape. We'll scope your observability implementation in 48 hours.</p>
