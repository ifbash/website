          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {cat.items.map(({ title, icon: Icon }) => (
              <Link
                ...
                className="group flex items-center gap-3.5 rounded-2xl border border-hairline bg-paper p-5 transition-all duration-300 hover:border-sea-soft hover:shadow-[0_8px_30px_rgba(24,19,18,0.06)] hover:-translate-y-0.5"
              >
