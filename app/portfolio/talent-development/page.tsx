  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 width-sm-fix overflow-x-hidden max-w-[100vw]">
        {/* Hero Section */}
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-amber-900 via-yellow-900 to-orange-900 py-4 sm:py-16 md:py-24 w-full">
  ...
  if (typeof document !== 'undefined') {
    ...
    if (element) {
      element.scrollIntoView({ behavior: 'smooth' });
        ...
        {/* Benefits Section */}
        <section id="benefits" className="py-4 sm:py-16 md:py-24 w-full bg-gradient-to-br from-gray-50 to-amber-50/30 relative overflow-hidden">
          <div className="w-[92%] sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto px-2 sm:px-0">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-8">
        ...
        <section className="py-4 sm:py-16 md:py-24 w-full bg-gradient-to-br from-gray-50 to-orange-50/30 relative overflow-hidden">
          <div className="w-[92%] sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto px-2 sm:px-0">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
        ...
        {/* FAQ Section */}
        <section className="py-4 sm:py-16 md:py-24 w-full bg-gradient-to-br from-gray-50 to-pink-50/30 relative overflow-hidden">
          <div className="w-[92%] sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto px-2 sm:px-0">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
        ...
        <section className="py-4 sm:py-16 md:py-24 w-full bg-gradient-to-r from-rose-900 via-red-900 to-orange-900 text-white relative overflow-hidden">
        ...
        {/* Call to Action */}
        <section className="py-4 sm:py-16 md:py-24 w-full bg-gradient-to-br from-gray-50 to-rose-50/30 relative overflow-hidden">
