  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 width-sm-fix overflow-x-hidden max-w-[100vw]">
        {/* Hero Section */}
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-cyan-900 via-blue-900 to-indigo-900 py-4 sm:py-16 md:py-24 w-full">
  ...
  if (typeof document !== 'undefined') {
    ...
    if (element) {
      element.scrollIntoView({ behavior: 'smooth' });
        ...
        {/* Benefits Section */}
        <section id="benefits" className="py-4 sm:py-16 md:py-24 w-full bg-gradient-to-br from-gray-50 to-cyan-50/30 relative overflow-hidden">
        ...
        <section className="py-4 sm:py-16 md:py-24 bg-gradient-to-r from-red-900 via-rose-900 to-pink-900 text-white relative overflow-hidden">
