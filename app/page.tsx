...
{['AI-Powered Case Resolution', 'Agentic AI Workflow Automation', 'CRM Lead Conversion Boost'].map((metric, index) => (
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 px-6">
    ...
    <div className="space-y-4">
      <div className="flex items-center space-x-3">
        <div className="h-14 w-14 flex items-center justify-center bg-gradient-to-r from-indigo-600 to-blue-500 rounded-2xl shadow-xl">
          <span className="text-white font-bold text-xl">IB</span>
        </div>
        <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-blue-400">
          ifBash
        </span>
      </div>
      <p className="text-gray-400 text-sm sm:text-base">
        Leading ServiceNow consulting firm delivering AI-powered CRM solutions and digital transformation excellence.
      </p>
      <div className="flex space-x-4 mt-4">
        {[LinkedinIcon, Twitter, Instagram, Youtube, Music].map((Icon, i) => (
          <a key={i} href="#" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform duration-300">
            <Icon className="h-6 w-6 text-gray-200 hover:text-indigo-400" />
          </a>
        ))}
      </div>
    </div>
    ...
    {/* Services */}
    <div>
      <h4 className="font-bold text-lg mb-4 text-gray-100">Services</h4>
      <ul className="space-y-2 text-sm">
        {['AI & Automation', 'CRM Solutions', 'Digital Transformation', 'ITSM Implementation', 'Managed Services'].map((item) => (
          <li key={item}>
            <a href="#" className="hover:text-indigo-400 transition-colors duration-300">{item}</a>
          </li>
        ))}
      </ul>
    </div>
    ...
    {/* Resources */}
    <div>
      <h4 className="font-bold text-lg mb-4 text-gray-100">Resources</h4>
      <ul className="space-y-2 text-sm">
        {['Learning Center', 'Case Studies', 'White Papers', 'Webinars', 'Blog'].map((item) => (
          <li key={item}>
            <a href="#" className="hover:text-indigo-400 transition-colors duration-300">{item}</a>
          </li>
        ))}
    ...
    <div>
      ...
      <ul className="space-y-3 text-sm">
        <li className="flex items-center gap-2">📞 +1-800-IFBASH</li>
        <li className="flex items-center gap-2">✉ hello@ifbash.com</li>
        <li className="flex items-center gap-2">🌍 Global Offices</li>
      </ul>
    </div>
  ...
  <div className="mt-16 border-t border-gray-800 pt-6 text-center text-gray-500 text-sm">
    © 2024 ifBash. All rights reserved. | <a href="#" className="hover:text-indigo-400">Privacy Policy</a> | <a href="#" className="hover:text-indigo-400">Terms of Service</a>
  </div>
</footer>
