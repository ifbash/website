      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="prose prose-gray max-w-none space-y-10">
          ...
          <section>
            ...
            <p className="text-stone mb-3">We may collect the following types of information:</p>
          ...
          <section>
            ...
            <p className="text-stone mb-3">Depending on your location, you may have the right to:</p>
            <ul className="list-disc pl-6 space-y-2 text-stone">
