      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 rounded-lg bg-sea-tint">
              <Shield className="h-6 w-6 text-sea" />
            </div>
        ...
        <div className="prose prose-gray max-w-none space-y-10">
          ...
          <section>
            ...
            <p className="text-slate mb-3">We may collect the following types of information:</p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-ink mb-3">3. Sharing of Information</h2>
          ...
          <section>
            ...
            <p className="text-slate">
              ...
              Please see our{" "}
              <Link href="/cookies" className="text-sea hover:underline">
                Cookie Policy
              </Link>{" "}
          ...
          <section>
            ...
            <p className="text-slate mb-3">Depending on your location, you may have the right to:</p>
            <ul className="list-disc pl-6 space-y-2 text-slate">
