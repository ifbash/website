...
export default function ServiceNowEmployeePage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center">
          <div className="flex-1">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <Badge variant="outline" className="text-primary border-primary/20">Employee Solutions</Badge>
            </div>
            <h1 className="text-4xl font-bold text-foreground mb-4">
              Empower Your Workforce with ServiceNow Employee Solutions
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed mb-6">
              Transform employee experiences and HR operations with ServiceNow-powered solutions from IfBash. Enable frictionless onboarding, self-service, and productivity for a modern, engaged workforce.
            </p>
            <ul className="list-disc pl-6 text-muted-foreground mb-6">
              <li>Automated HR workflows and case management</li>
              <li>Employee self-service portals and mobile access</li>
              <li>Unified data for HR, IT, and facilities</li>
              <li>Real-time analytics and engagement insights</li>
              <li>Enterprise-grade security and compliance</li>
            </ul>
            <Button size="lg" variant="secondary" className="px-8 py-3 mb-4">
              Explore ServiceNow Employee Solutions
          ...
          <div className="flex-1 flex justify-center">
            <img
              ...
              alt="ServiceNow Employee Solutions"
      ...
      {/* ServiceNow Employee Use Cases */}
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-light text-foreground mb-12 text-center">
            ServiceNow Employee Solutions: Key Enterprise Use Cases
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="moondust-card border-border shadow-sm hover:shadow-lg hover:moondust-glow transition-all duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm mb-4">
                  Connect HR, IT, and facilities systems for unified employee data and seamless operations.
                </p>
                <ul className="space-y-2 text-xs text-muted-foreground">
                  <li className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 text-green-500" />
            ...
            <Card className="moondust-card border-border shadow-sm hover:shadow-lg hover:moondust-glow transition-all duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm mb-4">
                  Future-proof your employee operations with modular, upgradable ServiceNow solutions.
                </p>
                <ul className="space-y-2 text-xs text-muted-foreground">
                  <li className="flex items-center space-x-2">
                    <CheckCircle className="h-3 w-3 text-green-500" />
      ...
      {/* How IfBash Accelerates Employee Solutions */}
      <section className="py-16 px-6 bg-gradient-to-r from-indigo-50 to-blue-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-light text-foreground mb-10 text-center">
            How IfBash Accelerates Your ServiceNow Employee Solutions
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
              ...
              <p className="text-muted-foreground text-sm text-center">
                Empower employees with intuitive portals, mobile access, and virtual agents for instant support.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
              <img
              ...
              <p className="text-muted-foreground text-sm text-center">
                Deliver real-time dashboards and predictive analytics to boost employee engagement and productivity.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-3xl font-light text-foreground mb-8 text-center">
            Case Study: Employee Experience Transformation for a Global Enterprise
          </h2>
          <div className="bg-gray-50 rounded-xl shadow-lg p-8 flex flex-col md:flex-row gap-8">
            <div className="flex-1">
              ...
              <p className="mb-6 text-muted-foreground">
                IfBash implemented ServiceNow Employee Center, automating HR workflows and enabling self-service for employees worldwide.
              </p>
      ...
      <section className="py-10 px-6 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-light text-foreground mb-8 text-center">
            Why IfBash & ServiceNow for Employee Experience Transformation?
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Trusted by global organizations for secure, compliant, and scalable employee solutions.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Harness automation, AI, and analytics for smarter employee engagement and productivity.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  From strategy to implementation and optimization, IfBash is your partner for employee experience success.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-indigo-600 to-blue-700">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-light text-white mb-6">
            Transform Your Employee Experience with ServiceNow & IfBash
          </h2>
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            Accelerate your employee experience transformation with ServiceNow and IfBash—trusted by leaders for measurable results.
          </p>
