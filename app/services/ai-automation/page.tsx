                  ...
                  <div className="grid lg:grid-cols-2 gap-8 items-center">
                    <div className={`order-2 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                      ...
                      <div className="space-y-6">
                        <div>
                          <h4 className="text-lg font-semibold mb-3 text-violet-200">Key Activities</h4>
                        ...
                        <div>
                          <h4 className="text-lg font-semibold mb-3 text-violet-200">Key Deliverables</h4>
                          <div className="space-y-2">
                        ...
                        <div className={`aspect-square bg-gradient-to-br from-violet-500/20 to-purple-500/20 rounded-3xl p-8 backdrop-blur-sm border border-violet-400/20 hover:border-violet-400/40 transition-all duration-500 transform group-hover:scale-105`}>
                          <div className={`w-full h-full bg-gradient-to-br from-violet-600/30 to-purple-600/30 rounded-2xl flex items-center justify-center relative overflow-hidden`}>
                            ...
                            <div className="text-center relative z-10">
                              <div className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-400 mb-4">
                                0{index + 1}
                              </div>
                  ...
                  <div className="grid lg:grid-cols-2 gap-8 items-center">
                    <div className={`${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          <h4 className="text-lg font-semibold text-blue-600 mb-2">AI Solution</h4>
                          <p className="text-gray-600 leading-relaxed">{study.solution}</p>
                        </div>

                        <div>
                          <h4 className="text-lg font-semibold text-green-600 mb-3">AI Impact</h4>
                    ...
                    <div key={index} className="w-full flex-shrink-0">
                      <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-8 md:p-12 border border-white/20">
                        <div className="flex items-center mb-8">
                          <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-violet-500 rounded-full flex items-center justify-center mr-6">
