            ...
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-4">
              {p.items.map(({ title, href, icon: Icon, note }) => (
                <Link
                  key={href + title}
                  href={href}
                  className="group flex items-start gap-3.5 rounded-2xl border border-hairline bg-paper p-5 transition-all duration-300 hover:border-sea-soft hover:shadow-[0_8px_30px_rgba(14,17,32,0.06)] hover:-translate-y-0.5"
                >
