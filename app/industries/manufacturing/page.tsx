...
export default function ManufacturingPage() {
  return (
    <>
      <Head>
        <title>Manufacturing Digital Transformation | ServiceNow & IfBash</title>
        <meta name="description" content="Drive operational excellence, resilience, and innovation in manufacturing with ServiceNow, AI, and CRM. Modernize plants, supply chains, and customer experience with IfBash." />
        <meta name="keywords" content="Manufacturing, ServiceNow, AI, CRM, Digital Transformation, Smart Factory, Supply Chain, ESG, IfBash" />
        <meta property="og:title" content="Manufacturing Digital Transformation | ServiceNow & IfBash" />
        <meta property="og:description" content="Accelerate manufacturing innovation and customer loyalty with ServiceNow, AI, and CRM solutions from IfBash." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=600&q=80" />
          ...
          <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center">
            <div className="flex-1">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <Badge variant="outline" className="text-primary border-primary/20">Manufacturing</Badge>
              </div>
              <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-4">
                Transform Manufacturing with ServiceNow & IfBash
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed mb-6">
                Drive operational excellence, resilience, and innovation across plants, supply chains, and customer service. IfBash leverages ServiceNow, AI, and CRM to help manufacturers modernize operations, connect ecosystems, and deliver seamless experiences.
              </p>
              <ul className="list-disc pl-6 text-muted-foreground mb-6">
                ...
                <li>Deliver frictionless customer journeys from order to aftersales</li>
                <li>Leverage real-time analytics and CRM for smarter decisions</li>
                <li>Enable smart factories and digital services</li>
              </ul>
              ...
              <div>
                ...
                <ul className="space-y-4 text-base sm:text-lg text-muted-foreground">
                  <li>
                    ...
                    <strong className="text-primary">Industry Expertise:</strong> Trusted by global manufacturers for digital transformation.
                  </li>
                  <li>
        ...
        <section className="py-16 px-4 sm:px-6">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Smart Factory & Asset Management */}
              <Card className="moondust-card border-border shadow-sm hover:shadow-lg hover:moondust-glow transition-all duration-300">
                <CardHeader className="pb-4">
                  <div className="h-12 w-12 rounded-lg bg-primary/20 flex items-center justify-center mb-3">
                    <Settings className="h-6 w-6 text-primary" />
                  </div>
                  <CardTitle className="text-lg">Smart Factory & Asset Management</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm mb-4">
                    Optimize plant operations, asset lifecycle, and maintenance with AI-powered workflows and IoT integration.
                  </p>
                  <ul className="space-y-2 text-xs text-muted-foreground">
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-3 w-3 text-green-500" />
                      <span>Downtime & Incident Management</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="moondust-card border-border shadow-sm hover:shadow-lg hover:moondust-glow transition-all duration-300">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-lg">Supply Chain & Supplier Collaboration</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm mb-4">
              ...
              <Card className="moondust-card border-border shadow-sm hover:shadow-lg hover:moondust-glow transition-all duration-300">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-lg">Customer Experience & Order Management</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm mb-4">
                    Deliver seamless support, order tracking, and personalized journeys with unified CRM and AI-powered service management.
                  </p>
                  <ul className="space-y-2 text-xs text-muted-foreground">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-3 w-3 text-green-500" />
                      <span>Order Status & Case Management</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-3 w-3 text-green-500" />
              ...
              <Card className="moondust-card border-border shadow-sm hover:shadow-lg hover:moondust-glow transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-muted-foreground text-sm mb-4">
                    Connect distributors, partners, and customers with unified CRM, sales, and service management.
                  </p>
                  <ul className="space-y-2 text-xs text-muted-foreground">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="h-3 w-3 text-green-500" />
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
                ...
                <p className="text-muted-foreground text-sm text-center">
                  Deliver frictionless support, order tracking, and personalized journeys to build loyalty and trust.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">
                  Develop tailored ServiceNow, AI, and CRM solutions for manufacturing needs.
                </p>
              </div>
              <div className="text-center">
                <div className="h-16 w-16 rounded-full bg-primary/20 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-muted-foreground text-sm">
                  Deploy and integrate digital workflows across plants, supply chain, and customer service.
                </p>
              </div>
              <div className="text-center">
                <div className="h-16 w-16 rounded-full bg-primary/20 flex items-center justify-center mx-auto mb-4">
        ...
        <section className="py-10 px-4 sm:px-6 bg-gradient-to-r from-blue-50 to-indigo-50">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl font-light text-foreground mb-8 text-center">
              Why IfBash & ServiceNow for Manufacturing?
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Proven delivery for global manufacturers, suppliers, and distributors. Enterprise-grade security, compliance, and data protection.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Flexible platforms that grow with your business and adapt to new manufacturing trends.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
          ...
          <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="shadow-lg border-none">
                <CardContent className="p-6">
                  <p className="text-lg text-muted-foreground mb-4">
                    “IfBash helped us optimize our production and supply chain. Downtime dropped by 25% and customer satisfaction is at a record high.”
                  </p>
                  <div className="flex items-center space-x-3">
                    <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="Client" className="h-10 w-10 rounded-full" />
                    <div>
                      <span className="font-semibold text-primary">Alex T.</span>
                      <span className="block text-xs text-muted-foreground">COO, Global Manufacturer</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              <Card className="shadow-lg border-none">
                <CardContent className="p-6">
                  <p className="text-lg text-muted-foreground mb-4">
                    “The ServiceNow platform and AI solutions from IfBash transformed our customer experience. We’re now leaders in loyalty and aftersales support.”
                  </p>
                  <div className="flex items-center space-x-3">
                    <img src="https://randomuser.me/api/portraits/women/65.jpg" alt="Client" className="h-10 w-10 rounded-full" />
                    <div>
                      <span className="font-semibold text-primary">Maria S.</span>
                      <span className="block text-xs text-muted-foreground">VP, Manufacturing Operations</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  Most clients see measurable improvements in production, supply chain, and customer experience within 3-6 months of implementation.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-primary mb-2">Is your solution scalable for global manufacturing enterprises?</h3>
                <p className="text-muted-foreground">
        ...
        <section className="py-16 px-4 sm:px-6 bg-gradient-to-r from-indigo-600 to-blue-700">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">
              Drive Manufacturing Innovation with ServiceNow & IfBash
            </h2>
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              Transform your manufacturing business with digital workflows, AI, CRM, and customer-centric solutions.
            </p>
