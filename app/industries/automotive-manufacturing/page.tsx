                  ...
                  <div className="grid lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className={`order-1 ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                      <div className="relative">
                        <div className={`aspect-square bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-3xl p-4 sm:p-8 backdrop-blur-sm border border-blue-400/20 hover:border-blue-400/40 transition-all duration-500`}>
