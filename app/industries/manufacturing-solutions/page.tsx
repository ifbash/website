  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {manufacturingSolutions.map((solution, index) => (
                <div key={index} className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-orange-100 hover:border-orange-300 transform hover:-translate-y-2">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {manufacturingMetrics.map((metric, index) => (
                <div key={index} className="group text-center bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-orange-200">
        ...
        <section className="py-16 md:py-24 bg-gradient-to-r from-gray-900 via-orange-900 to-red-900 text-white relative overflow-hidden">
          <div className="absolute inset-0 bg-grid-pattern opacity-10" />
          ...
          <div className="w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            <div className="text-center mb-16" data-animate id="implementation">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-red-400 to-pink-400">
                  Our Manufacturing Implementation
                </span>
                <br />
              ...
              <p className="text-lg md:text-xl text-orange-100 max-w-3xl mx-auto leading-relaxed">
                A specialized 4-phase methodology designed specifically for manufacturing industry requirements and Industry 4.0 transformation.
              </p>
            </div>
                ...
                <div key={index} className="group relative" data-animate id={`phase-${index}`}>
                  <div className="grid lg:grid-cols-2 gap-8 items-center">
                    <div className={`order-2 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                      <div className="flex items-center mb-6">
                        ...
                        <div>
                          ...
                          <div className="text-orange-200 flex items-center">
                      ...
                      <div className="space-y-6">
                        <div>
                          <h4 className="text-lg font-semibold mb-3 text-orange-200">Key Activities</h4>
                        ...
                        <div>
                          <h4 className="text-lg font-semibold mb-3 text-orange-200">Key Deliverables</h4>
                          <div className="space-y-2">
                            {phase.deliverables.map((deliverable, idx) => (
                              <div key={idx} className="flex items-center">
                                <FileText className="h-4 w-4 text-red-400 mr-3 flex-shrink-0" />
                    ...
                    <div className={`order-1 ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                      <div className="relative">
                        <div className={`aspect-square bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-3xl p-8 backdrop-blur-sm border border-orange-400/20 hover:border-orange-400/40 transition-all duration-500 transform group-hover:scale-105`}>
                          <div className={`w-full h-full bg-gradient-to-br from-orange-600/30 to-red-600/30 rounded-2xl flex items-center justify-center relative overflow-hidden`}>
                  ...
                  {index < implementationApproach.length - 1 && (
                    <div className="flex justify-center mt-8 mb-8">
                      <div className="w-px h-12 bg-gradient-to-b from-orange-500 to-red-500 opacity-50"></div>
                    </div>
                  )}
                </div>
              ))}
            ...
            <div className="text-center mt-16">
              <button 
                onClick={() => window.open('https://meetings.hubspot.com/ifbash', '_blank')}
                className="group px-8 py-4 text-lg font-semibold text-white rounded-xl transition-all duration-300 relative overflow-hidden bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 hover:from-orange-700 hover:via-red-700 hover:to-pink-700 transform hover:scale-105"
                style={{
                  boxShadow: "0 20px 40px rgba(251, 146, 60, 0.4)"
                }}
              >
          ...
          <div className="w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            ...
            <div className="space-y-12">
              {caseStudies.map((study, index) => (
                <div key={index} className="group bg-white rounded-3xl p-8 md:p-12 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-red-200 transform hover:-translate-y-2" data-animate id={`case-${index}`}>
                  <div className="grid lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                      <div className="relative">
                        <div className="aspect-square bg-gradient-to-br from-red-100 to-orange-100 rounded-2xl p-6 overflow-hidden">
                          <PlaceholderImage
        ...
        <section className="py-16 md:py-24 bg-gradient-to-r from-red-900 via-orange-900 to-pink-900 text-white relative overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-grid-pattern opacity-10" />
                    ...
                    <div key={index} className="w-full flex-shrink-0">
                      <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-8 md:p-12 border border-white/20">
                        <div className="flex items-center mb-8">
                          <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-red-500 rounded-full flex items-center justify-center mr-6">
        ...
        {/* FAQ Section */}
        <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-orange-50/20 relative overflow-hidden">
          <div className="absolute inset-0">
          ...
          <div className="w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            ...
            {/* Final CTA */}
            <div className="text-center mt-16">
              <div className="bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 rounded-3xl p-8 md:p-12 text-white">
                ...
                <button 
                  onClick={() => window.open('https://meetings.hubspot.com/ifbash', '_blank')}
                  className="group px-8 py-4 text-lg font-semibold bg-white text-orange-600 rounded-xl hover:bg-gray-50 transition-all duration-300 transform hover:scale-105"
                >
