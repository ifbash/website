...
export default function LifeSciencesPage() {
  return (
    <>
      <Head>
        <title>Life Sciences Digital Transformation | ServiceNow & IfBash</title>
        <meta name="description" content="Accelerate innovation, compliance, and patient outcomes in life sciences with ServiceNow, AI, and CRM. Modernize R&D, clinical trials, supply chain, and patient experience with IfBash." />
        <meta name="keywords" content="Life Sciences, ServiceNow, AI, CRM, Digital Transformation, R&D, Clinical Trials, Compliance, Patient Experience, IfBash" />
        <meta property="og:title" content="Life Sciences Digital Transformation | ServiceNow & IfBash" />
        <meta property="og:description" content="Accelerate innovation, compliance, and patient outcomes in life sciences with ServiceNow, AI, and CRM solutions from IfBash." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1465101178521-c1a4c8a0f3b7?auto=format&fit=crop&w=600&q=80" />
              ...
              <div>
                ...
                <ul className="space-y-4 text-base sm:text-lg text-muted-foreground">
                  <li>
                    ...
                    <strong className="text-primary">Industry Expertise:</strong> Trusted by pharma, biotech, and medtech for digital transformation.
                  </li>
                  <li>
          ...
          <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="shadow-lg border-none">
                <CardContent className="p-6">
                  <p className="text-lg text-muted-foreground mb-4">
                    “IfBash helped us digitize R&D and automate compliance. Our product development cycle is faster and audit readiness is seamless.”
                  </p>
                  <div className="flex items-center space-x-3">
                    <img src="https://randomuser.me/api/portraits/men/34.jpg" alt="Client" className="h-10 w-10 rounded-full" />
                    <div>
                      <span className="font-semibold text-primary">Dr. Alex M.</span>
                      <span className="block text-xs text-muted-foreground">VP, Biotech R&D</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              <Card className="shadow-lg border-none">
                <CardContent className="p-6">
                  <p className="text-lg text-muted-foreground mb-4">
                    “The ServiceNow platform and AI solutions from IfBash transformed our clinical trials and patient engagement. We’re now leaders in innovation and compliance.”
                  </p>
                  <div className="flex items-center space-x-3">
                    <img src="https://randomuser.me/api/portraits/women/54.jpg" alt="Client" className="h-10 w-10 rounded-full" />
                    <div>
                      <span className="font-semibold text-primary">Priya S.</span>
                      <span className="block text-xs text-muted-foreground">Director, Clinical Operations</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  Most clients see measurable improvements in R&D, clinical trials, and compliance within 3-6 months of implementation.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-primary mb-2">Is your solution scalable for global life sciences organizations?</h3>
                <p className="text-muted-foreground">
                  Yes, our ServiceNow and AI solutions are designed for scalability, security, and compliance across pharma, biotech, and medtech.
                </p>
              </div>
              <div>
