        ...
        <section className="py-8 sm:py-16 md:py-24 bg-gradient-to-r from-gray-900 via-sky-900 to-blue-900 text-white relative overflow-hidden">
          <div className="w-full px-2 sm:px-4 md:px-8 lg:px-12 xl:px-16 max-w-[98vw] sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            <div className="text-center mb-16" data-animate id="implementation">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-blue-400 to-indigo-400">
                  Our Telecommunications Implementation
                </span>
                <br />
              ...
              <p className="text-lg md:text-xl text-sky-100 max-w-3xl mx-auto leading-relaxed">
                A specialized 4-phase methodology designed specifically for telecommunications requirements and network optimization.
              </p>
            </div>
                ...
                <div key={index} className="group relative" data-animate id={`phase-${index}`}>
                    ...
                    <div className={`order-2 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                      <div className="flex items-center mb-6">
                        ...
                        <div>
                          ...
                          <div className="text-sky-200 flex items-center">
                      ...
                      <div className="space-y-6">
                        <div>
                          <h4 className="text-lg font-semibold mb-3 text-sky-200">Key Activities</h4>
                          <div className="space-y-2">
                            {phase.activities.map((activity, idx) => (
                              <div key={idx} className="flex items-center">
                                <CheckCircle className="h-4 w-4 text-sky-400 mr-3 flex-shrink-0" />
                        ...
                        <div>
                          <h4 className="text-lg font-semibold mb-3 text-sky-200">Key Deliverables</h4>
                          <div className="space-y-2">
                            {phase.deliverables.map((deliverable, idx) => (
                              <div key={idx} className="flex items-center">
                                <FileText className="h-4 w-4 text-blue-400 mr-3 flex-shrink-0" />
                        ...
                        <div className={`aspect-square bg-gradient-to-br from-sky-500/20 to-blue-500/20 rounded-3xl p-8 backdrop-blur-sm border border-sky-400/20 hover:border-sky-400/40 transition-all duration-500`}>
                          <div className={`w-full h-full bg-gradient-to-br from-sky-600/30 to-blue-600/30 rounded-2xl flex items-center justify-center relative overflow-hidden`}>
                            ...
                            <div className="text-center relative z-10">
                              <div className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-400 mb-4">
                                0{index + 1}
                              </div>
                  ...
                  {index < implementationApproach.length - 1 && (
                    <div className="flex justify-center mt-8 mb-8">
                      <div className="w-px h-12 bg-gradient-to-b from-sky-500 to-blue-500 opacity-50"></div>
                    </div>
                  )}
                </div>
              ))}
            ...
            <div className="text-center mt-16">
              <button 
                onClick={() => window.open('https://meetings.hubspot.com/ifbash', '_blank')}
                className="group px-8 py-4 text-lg font-semibold text-white rounded-xl transition-all duration-300 relative overflow-hidden bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 hover:from-sky-700 hover:via-blue-700 hover:to-indigo-700 transform hover:scale-105"
                style={{
                  boxShadow: "0 20px 40px rgba(14, 165, 233, 0.4)"
                }}
              >
          ...
          <div className="w-full px-2 sm:px-4 md:px-8 lg:px-12 xl:px-16 max-w-[98vw] sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            ...
            <div className="text-center mt-16">
              <div className="bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 rounded-3xl p-8 md:p-12 text-white">
                ...
                <button 
                  onClick={() => window.open('https://meetings.hubspot.com/ifbash', '_blank')}
                  className="group px-8 py-4 text-lg font-semibold bg-white text-sky-600 rounded-xl hover:bg-gray-50 transition-all duration-300 transform hover:scale-105"
                >
