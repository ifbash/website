...
export default function TelecomsPage() {
  return (
    <>
      <Head>
        <title>Telecom Digital Transformation | ServiceNow & IfBash</title>
        <meta name="description" content="Accelerate telecom innovation, customer experience, and service delivery with ServiceNow, AI, and CRM. Modernize network operations, field service, and omni-channel support with IfBash." />
        <meta name="keywords" content="Telecom, ServiceNow, AI, CRM, Digital Transformation, Network Operations, Field Service, Omnichannel, Analytics, IfBash" />
        <meta property="og:title" content="Telecom Digital Transformation | ServiceNow & IfBash" />
        <meta property="og:description" content="Transform telecom experiences and operational excellence with ServiceNow, AI, and CRM solutions from IfBash." />
      ...
      <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center">
            <div className="flex-1">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <Badge variant="outline" className="text-primary border-primary/20">Telecom</Badge>
              </div>
              <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-4">
                Accelerate Telecom Transformation with ServiceNow & IfBash
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed mb-6">
                Modernize network operations, customer experience, and service delivery. IfBash leverages ServiceNow, AI, and CRM to help telecom providers automate workflows, optimize field service, and deliver seamless omni-channel support.
              </p>
              ...
              <div>
                ...
                <ul className="space-y-4 text-base sm:text-lg text-muted-foreground">
                  <li>
                    ...
                    <strong className="text-primary">Telecom Expertise:</strong> Trusted by operators, service providers, and resellers for digital transformation.
                  </li>
                  <li>
        ...
        <section className="py-16 px-4 sm:px-6">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl font-light text-foreground mb-12 text-center">
              ServiceNow for Telecom: Key Use Cases
            </h2>
        ...
        <section className="py-16 px-4 sm:px-6 bg-gradient-to-br from-slate-50 to-indigo-50">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl font-light text-foreground mb-12 text-center">
              Our Approach for Telecom Transformation
            </h2>
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm">
                  Develop tailored ServiceNow, AI, and CRM solutions for telecom needs.
                </p>
              </div>
              <div className="text-center">
                <div className="h-16 w-16 rounded-full bg-primary/20 flex items-center justify-center mx-auto mb-4">
        ...
        <section className="py-10 px-4 sm:px-6 bg-gradient-to-r from-blue-50 to-indigo-50">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl font-light text-foreground mb-8 text-center">
              Why IfBash & ServiceNow for Telecom?
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Proven delivery for telecom operators, service providers, and resellers. Enterprise-grade security, compliance, and data protection.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Flexible platforms that grow with your business and adapt to new telecom trends.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
          ...
          <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="shadow-lg border-none">
                <CardContent className="p-6">
                  <p className="text-lg text-muted-foreground mb-4">
                    “IfBash helped us automate network operations and improve field service. Our uptime and customer satisfaction are at an all-time high.”
                  </p>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className="block text-xs text-muted-foreground">CTO, Telecom Provider</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              <Card className="shadow-lg border-none">
                <CardContent className="p-6">
                  <p className="text-lg text-muted-foreground mb-4">
                    “The ServiceNow platform and AI solutions from IfBash transformed our customer experience and analytics. We’re now leaders in omni-channel support and retention.”
                  </p>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className="block text-xs text-muted-foreground">VP, Telecom Experience</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  Most clients see measurable improvements in network operations, field service, and customer experience within 3-6 months of implementation.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-primary mb-2">Is your solution scalable for global telecom enterprises?</h3>
                <p className="text-muted-foreground">
        ...
        <section className="py-16 px-4 sm:px-6 bg-gradient-to-r from-indigo-600 to-blue-700">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">
              Drive Telecom Innovation with ServiceNow & IfBash
            </h2>
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              Transform your telecom business with digital workflows, AI, CRM, and customer-centric solutions.
            </p>
