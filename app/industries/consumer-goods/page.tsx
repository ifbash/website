...
export default function ConsumerGoodsPage() {
  return (
    <>
      <Head>
        <title>Consumer Goods Digital Transformation | ServiceNow & IfBash</title>
        <meta name="description" content="Modernize consumer goods with ServiceNow, AI, and CRM. Optimize supply chain, retail, and consumer experience with IfBash." />
        <meta name="keywords" content="Consumer Goods, ServiceNow, AI, CRM, Digital Transformation, Supply Chain, Retail, Omnichannel, IfBash" />
        <meta property="og:title" content="Consumer Goods Digital Transformation | ServiceNow & IfBash" />
        <meta property="og:description" content="Accelerate growth and loyalty in consumer goods with ServiceNow, AI, and CRM solutions from IfBash." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1519864600265-abb23847ef2c?auto=format&fit=crop&w=600&q=80" />
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        {/* Hero Section */}
        <section className="py-16 px-4 sm:px-6 bg-gradient-to-r from-green-50 to-blue-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <ul className="space-y-4 text-base sm:text-lg text-muted-foreground">
                  <li>
                    <Star className="inline-block mr-2 text-[#26a3d9]" />
                    <strong className="text-primary">Industry Expertise:</strong> Trusted by global brands for supply chain, retail, and consumer experience transformation.
                  </li>
                  <li>
                  ...
                  <li>
                    <Leaf className="inline-block mr-2 text-[#26a3d9]" />
                    <strong className="text-primary">Sustainability Focus:</strong> Digital solutions for ESG, compliance, and responsible growth.
                  </li>
                  <li>
        ...
        <section className="py-16 px-4 sm:px-6 bg-gradient-to-r from-blue-50 to-green-50">
          <div className="container mx-auto max-w-6xl">
        ...
        {/* Approach Section */}
        <section className="py-16 px-4 sm:px-6 bg-gradient-to-br from-slate-50 to-green-50">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl font-light text-foreground mb-12 text-center">
        ...
        <section className="py-10 px-4 sm:px-6 bg-gradient-to-r from-blue-50 to-green-50">
          <div className="container mx-auto max-w-6xl">
        ...
        <section className="py-16 px-4 sm:px-6 bg-white">
          <div className="container mx-auto max-w-5xl">
            <h2 className="text-3xl font-light text-primary mb-10 text-center">
              What Our Consumer Goods Clients Say
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="shadow-lg border-none">
                <CardContent className="p-6">
                  <p className="text-lg text-muted-foreground mb-4">
                    “IfBash helped us optimize our supply chain and retail execution. Our on-shelf availability improved by 20% and consumer satisfaction is at a record high.”
                  </p>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className="block text-xs text-muted-foreground">COO, Global FMCG</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              <Card className="shadow-lg border-none">
                <CardContent className="p-6">
                  <p className="text-lg text-muted-foreground mb-4">
                    “The ServiceNow platform and AI solutions from IfBash transformed our consumer experience. We’re now leaders in loyalty and omnichannel support.”
                  </p>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className="block text-xs text-muted-foreground">VP, Retail Operations</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  Most clients see measurable improvements in supply chain, retail, and consumer experience within 3-6 months of implementation.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-primary mb-2">Is your solution scalable for global consumer goods enterprises?</h3>
                <p className="text-muted-foreground">
        ...
        {/* CTA */}
        <section className="py-16 px-4 sm:px-6 bg-gradient-to-r from-green-600 to-blue-700">
