  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <section className="relative min-h-[70vh] sm:min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-900 via-emerald-900 to-teal-900">
          ...
          <div className="w-full px-2 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 items-center">
              ...
              <div className="relative sm:h-[400px] lg:h-[600px]">
                <div className="relative z-20 bg-gradient-to-br from-green-500/15 to-emerald-500/15 rounded-3xl p-2 sm:p-8 backdrop-blur-xl border border-gray-300/20 hover:border-gray-300/30 transition-all duration-500">
          ...
          <div className="w-full px-2 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-8 mb-8 sm:mb-16">
              {retailSolutions.map((solution, index) => (
                <div key={index} className="group relative bg-white rounded-2xl p-4 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-green-100 hover:border-green-300 transform hover:-translate-y-2">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-8">
              {retailMetrics.map((metric, index) => (
                <div key={index} className="group text-center bg-white rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-green-200">
        ...
        <section className="py-8 sm:py-16 md:py-24 bg-gradient-to-r from-gray-900 via-green-900 to-emerald-900 text-white relative overflow-hidden">
          <div className="absolute inset-0 bg-grid-pattern opacity-10" />
          ...
          <div className="w-full px-2 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            <div className="text-center mb-8 sm:mb-16" data-animate id="implementation">
              ...
              <p className="text-xs sm:text-lg md:text-xl text-green-100 max-w-xs sm:max-w-3xl mx-auto leading-relaxed">
                  ...
                  <div className="grid lg:grid-cols-2 gap-8 items-center">
                    <div className={`order-2 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                      ...
                      <div className="space-y-4 sm:space-y-6">
                        <div>
                          <h4 className="text-lg font-semibold mb-2 text-green-200">Key Activities</h4>
                        ...
                        <div>
                          <h4 className="text-lg font-semibold mb-2 text-green-200">Key Deliverables</h4>
                          <div className="space-y-2">
                    ...
                    <div className={`order-1 ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                      <div className="relative">
                        <div className={`aspect-square bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-3xl p-4 sm:p-8 backdrop-blur-sm border border-green-400/20 hover:border-green-400/40 transition-all duration-500`}>
                          <div className={`w-full h-full bg-gradient-to-br from-green-600/30 to-emerald-600/30 rounded-2xl flex items-center justify-center relative overflow-hidden`}>
                            ...
                            <div className="text-center relative z-10">
                              <div className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400 mb-2 sm:mb-4">
                                0{index + 1}
                              </div>
            ...
            <div className="text-center mt-8 sm:mt-16">
              <a href="/get-started"
                className="group px-8 py-4 text-sm sm:text-lg font-semibold text-white rounded-xl transition-all duration-300 relative overflow-hidden bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 hover:from-green-700 hover:via-emerald-700 hover:to-teal-700 transform hover:scale-105"
                style={{
                  boxShadow: "0 20px 40px rgba(34, 197, 94, 0.4)"
                }}
              >
          ...
          <div className="w-full px-2 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            ...
            <div className="space-y-4 sm:space-y-12">
              {caseStudies.map((study, index) => (
                <div key={index} className="group bg-white rounded-3xl p-4 sm:p-8 md:p-12 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-emerald-200 transform hover:-translate-y-2" data-animate id={`case-${index}`}>
                  <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 items-center">
                    ...
                    <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                      <div className="relative">
                        <div className="aspect-square bg-gradient-to-br from-emerald-100 to-green-100 rounded-2xl p-4 sm:p-8 overflow-hidden">
                          <PlaceholderImage
        ...
        <section className="py-8 sm:py-16 md:py-24 bg-gradient-to-r from-emerald-900 via-green-900 to-teal-900 text-white relative overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-grid-pattern opacity-10" />
          ...
          <div className="w-full px-2 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            <div className="text-center mb-8 sm:mb-16" data-animate id="testimonials">
              ...
              <p className="text-xs sm:text-lg md:text-xl text-emerald-100 max-w-xs sm:max-w-3xl mx-auto leading-relaxed">
                    ...
                    <div key={index} className="w-full flex-shrink-0">
                      <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-4 sm:p-8 md:p-12 border border-white/20">
                        <div className="flex items-center mb-4 sm:mb-8">
                          <div className="w-16 h-16 bg-gradient-to-r from-teal-500 to-emerald-500 rounded-full flex items-center justify-center mr-4 sm:mr-6">
        ...
        {/* FAQ Section */}
        <section className="py-8 sm:py-16 md:py-24 bg-gradient-to-br from-gray-50 to-green-50/20 relative overflow-hidden">
          <div className="absolute inset-0">
          ...
          <div className="w-full px-2 sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] mx-auto relative z-10">
            ...
            {/* Final CTA */}
            <div className="text-center mt-8 sm:mt-16">
              <div className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 rounded-3xl p-4 sm:p-8 md:p-12 text-white">
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">
                  Ready to Transform Your Retail Operations?
                </h3>
                <p className="text-xs sm:text-lg md:text-xl text-green-100 mb-4 sm:mb-8 max-w-xs sm:max-w-2xl mx-auto">
                  Join retail leaders driving sales growth. Get e-commerce solutions that deliver 156% better conversions and $134M growth.
                </p>
                <a href="/get-started"
                  className="group px-8 py-4 text-sm sm:text-lg font-semibold bg-white text-green-600 rounded-xl hover:bg-gray-50 transition-all duration-300 transform hover:scale-105"
                >
