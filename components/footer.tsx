...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden" style={{ background: "#181312", borderTop: "3px solid #B23A2B" }}>
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Top — logo + newsletter */}
        <div className="grid lg:grid-cols-2 gap-12 py-10 border-b border-onink-line items-start">
          <div>
            <Link href="/">
              ...
              <div className="pt-4 border-t border-onink-line mt-6">
                ...
                <div className="flex flex-col gap-2">
                  <Link
                    ...
                    style={{ background: "#B23A2B", boxShadow: "0 4px 16px rgba(178,58,43,0.3)" }}
                  >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="w-7 h-7 rounded-lg bg-onink-fill hover:bg-onink-line border border-onink-line flex items-center justify-center transition-all"
              aria-label="Scroll to top"
            >
              <ChevronUp className="h-3.5 w-3.5 text-onink-muted" />
            </button>
          </div>
        </div>
