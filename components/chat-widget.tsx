  ...
  return (
    <div className="fixed right-4 sm:right-6 bottom-6 sm:bottom-8 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className="relative group w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center bg-sky text-paper shadow-[0_8px_32px_rgba(37,99,235,0.35)] hover:shadow-xl hover:bg-sky-deep transition-all duration-300 active:scale-95"
      >
